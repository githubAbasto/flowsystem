...
static inline const struct mgos_config_site * mgos_sys_config_get_site(void) { return mgos_config_get_site(&mgos_sys_config); }
...
static inline const char * mgos_sys_config_get_site_id(void) { return mgos_config_get_site_id(&mgos_sys_config); }
void mgos_config_set_site_id(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_site_id(const char * v) { mgos_config_set_site_id(&mgos_sys_config, v); }
...
static inline const char * mgos_sys_config_get_site_position(void) { return mgos_config_get_site_position(&mgos_sys_config); }
void mgos_config_set_site_position(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_site_position(const char * v) { mgos_config_set_site_position(&mgos_sys_config, v); }
