 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.18.0/apps/flowsystem/esp32/build_contexts/build_ctx_247258499/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.18.0/apps/flowsystem/esp32/build_contexts/build_ctx_247258499/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[193] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 192},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "site", .offset = offsetof(struct mgos_config, site), .num_desc = 2},
  {.type = CONF_TYPE_STRING, .key = "id", .offset = offsetof(struct mgos_config, site.id)},
  {.type = CONF_TYPE_STRING, .key = "position", .offset = offsetof(struct mgos_config, site.position)},
};
...
const struct mgos_config mgos_config_defaults = {
  ...
  .wifi.sta1.enable = 0,
  .wifi.sta1.ssid = "MajasLoveNet",
  .wifi.sta1.pass = "loveisintheair",
  .wifi.sta1.user = NULL,
  ...
  .wifi.sta2.enable = 0,
  .wifi.sta2.ssid = "MajasLoveNet",
  .wifi.sta2.pass = "loveisintheair",
  .wifi.sta2.user = NULL,
...
/* site */
#define MGOS_CONFIG_HAVE_SITE
#define MGOS_SYS_CONFIG_HAVE_SITE
const struct mgos_config_site * mgos_config_get_site(struct mgos_config *cfg) {
  return &cfg->site;
}
const struct mgos_conf_entry *mgos_config_schema_site(void) {
  return mgos_conf_find_schema_entry("site", mgos_config_schema());
}
bool mgos_config_parse_site(struct mg_str json, struct mgos_config_site *cfg) {
  return mgos_conf_parse_sub(json, mgos_config_schema(), cfg);
}
bool mgos_config_copy_site(const struct mgos_config_site *src, struct mgos_config_site *dst) {
  return mgos_conf_copy(mgos_config_schema_site(), src, dst);
}
void mgos_config_free_site(struct mgos_config_site *cfg) {
  return mgos_conf_free(mgos_config_schema_site(), cfg);
}

/* site.id */
#define MGOS_CONFIG_HAVE_SITE_ID
#define MGOS_SYS_CONFIG_HAVE_SITE_ID
const char * mgos_config_get_site_id(struct mgos_config *cfg) {
  return cfg->site.id;
}
void mgos_config_set_site_id(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->site.id, v);
}

/* site.position */
#define MGOS_CONFIG_HAVE_SITE_POSITION
#define MGOS_SYS_CONFIG_HAVE_SITE_POSITION
const char * mgos_config_get_site_position(struct mgos_config *cfg) {
  return cfg->site.position;
}
void mgos_config_set_site_position(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->site.position, v);
}
